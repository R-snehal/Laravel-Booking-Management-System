                ...
                <div class="collapse navbar-collapse" id="navbar1">
                    <div class="navbar-nav mx-auto text-black">
                        ...
                        <a href="#" class="navbar-brand d-none d-md-block">
                           <img src="<?php echo e(asset('assets/images/logo.jpg')); ?>"  alt="Brand Logo">
                        </a>
                        <a href="<?php echo e(url('page/about-us')); ?>" class="nav-link text-black">About Us</a>
                        <a href="<?php echo e(url('page/contact-us')); ?>" class="nav-item nav-link text-black">Contact Us</a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.baseview', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\LaravelBookingms\bookingms\resources\views/index.blade.php ENDPATH**/ ?>